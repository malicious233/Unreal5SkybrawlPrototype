...
ASkybrawlProject2022Character::ASkybrawlProject2022Character()
{
...
void ASkybrawlProject2022Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void ASkybrawlProject2022Character::GoToIdleOrAirborne()
{
	...
	{
		StatemachineComponent->SetState(AirborneState);
	}
	else
	{
		StatemachineComponent->SetState(IdleState);
...
void ASkybrawlProject2022Character::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
